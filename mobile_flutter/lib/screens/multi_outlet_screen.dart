...
class _MultiOutletScreenState extends State<MultiOutletScreen> {
  ...
  List<dynamic> _branches = [
    {'id': 1, 'name': 'Cabang Utama (Pusat Retail)', 'type': 'Minimarket & Retail', 'omset': 8450000, 'products_count': 120, 'status': 'Online'},
    {'id': 2, 'name': 'Cabang 2 (Cafe & Resto)', 'type': 'Food & Beverage', 'omset': 4250000, 'products_count': 45, 'status': 'Online'},
    {'id': 3, 'name': 'Cabang 3 (Apotek & Obat)', 'type': 'Kesehatan / Farmasi', 'omset': 3100000, 'products_count': 88, 'status': 'Online'},
  ];
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(_isConsolidated ? 'Menampilkan agregat seluruh outlet' : 'Menampilkan outlet ini saja', style: const TextStyle(color: Color(0xFF94A3B8), fontSize: 11)),
                    ],
                  ),
                  Switch(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text('TOTAL OMSET GABUNGAN (SEMUA CABANG)', style: TextStyle(color: Color(0xFF99F6E4), fontSize: 11, fontWeight: FontWeight.bold)),
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                          decoration: BoxDecoration(color: Colors.black26, borderRadius: BorderRadius.circular(8)),
                          child: Text('${_branches.length} Cabang Aktif', style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Text('Lintas Industri Terhubung ✓', style: TextStyle(color: Color(0xFF5EEAD4), fontSize: 12, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ],
                ),
